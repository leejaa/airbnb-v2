...
/* harmony import */ var _accessToken__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./accessToken */ "./apollo/accessToken.ts");
...
function createApolloClient(initialState = {}, serverAccessToken) {
  ...
  const refreshLink = new apollo_link_token_refresh__WEBPACK_IMPORTED_MODULE_7__["TokenRefreshLink"]({
    ...
    fetchAccessToken: () => {
      return isomorphic_unfetch__WEBPACK_IMPORTED_MODULE_6___default()(`http://localhost:3000/api`, {
        method: "POST",
        credentials: "include"
      });
    },
...
/* harmony import */ var _apollo_client__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../apollo/client */ "./apollo/client.tsx");
...
/* harmony default export */ __webpack_exports__["default"] = (Object(_apollo_client__WEBPACK_IMPORTED_MODULE_3__["withApollo"])(MyApp));
